...
| Path | Purpose |
|------|---------|
| `agents/` | Specifications for the 16 subagents that collect data, design the schema, and build the UI. Start with `agents/README.md`. |
...
| `scripts/` | Ingest, geocode, QA, and Parquet export pipeline (D2). |
