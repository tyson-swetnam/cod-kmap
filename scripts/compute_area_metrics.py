...
def main() -> int:
    ...
    # type View") — which crashed this script on any database built the
    # documented way. Drop whatever is there first, so the freshly exported
    # parquet wins regardless of how the DB was assembled.
    pq = ROOT / "db" / "parquet"
